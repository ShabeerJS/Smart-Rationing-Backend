...
//		}
	...
	public Product updateProduct(int productId, Product product) throws RationApplicationException {
		...
		Product product2 = productRepository.findById(productId).orElseThrow(()->new RationApplicationException("Not Found"));
...
//	}
	...
	public FixedProducts updateFixedProduct(int productId, FixedProducts fixedProducts) {
		FixedProducts fixedProductsNew= fixedProductRepository.findById(productId).orElseThrow(()->new RationApplicationException("Not Found"));
